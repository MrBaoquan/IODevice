...
namespace IOStudio.Controls.Timeline
{
    ...
    public partial class TrackClipControl : Control
    {
        ...
        private static readonly IBrush EmptyBrush = new SolidColorBrush(Color.Parse("#fafafa"));
        private static readonly IBrush GridLineBrush = new SolidColorBrush(Color.Parse("#f3f4f6"));
        private static readonly IPen GridPen = new Pen(GridLineBrush, 0.5);
