...
C_OK_BG   = RGBColor(0xE0, 0xF2, 0xED)   # 已完成浅绿底
...
txt(s, Inches(0.6), Inches(1.48), Inches(4), Inches(0.3),
    "系统架构 + 平台协议沟通", sz=12, color=C_LGRAY)

# 核心工作卡片
core_items = [
    ("1", "系统架构设计", "完成技术选型、模块划分、数据流设计\n系统接口定义、开发实施计划",
     "架构", C_PRIMARY),
...
txt(s, Inches(0.6), Inches(6.85), Inches(12), Inches(0.4),
    "共 6 项计划目标，其中系统架构设计与平台协议沟通为本阶段核心工作",
...
completed = [
    ["序号", "类别", "计划任务", "完成情况", "状态"],
    ["1", "核心", "系统架构设计", "完整架构文档 v8，含技术选型、模块划分、数据流图、接口定义 + 实施计划", "已完成"],
...
tbl(s, Inches(0.6), Inches(1.2), Inches(11.8), completed, cws)
...
# 总结
rrect(s, Inches(0.5), Inches(6.2), Inches(12.2), Inches(0.8), C_OK_BG)
mtxt(s, Inches(0.9), Inches(6.25), Inches(11.5), Inches(0.7), [
    ("历程总结：", True, C_DARK),
    ("测试工具开发完成，等待邯郸、濉溪项目测试验证", False, C_DARK),
], sz=13)
...
plan_full = [
    ...
    [NODE_LABELS[2], "4/30", "核心播控系统开发与基础联调完成", "当前阶段"],
...
tbl_ex(s, Inches(0.6), Inches(4.6), Inches(12), plan_full,
       ...
       row_colors={1: C_OK_BG}, highlight_row=2)
